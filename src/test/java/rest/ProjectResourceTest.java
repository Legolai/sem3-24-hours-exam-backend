...
class ProjectResourceTest {
    ...
    public void setUp() {
        ...
        try {
            ...
            Project project2 = new Project("ProjectTest2", "Some Project2", admin);

            Developer dev = new Developer(100.0, user);
            project1.addDeveloper(dev);
    ...
    public void testRestGetInvoiceForProject() {
        System.out.println(new InvoiceDTO(project1));
        login("admin@email.com", "test");
        given()
                .contentType("application/json")
                .accept(ContentType.JSON)
                ...
                .statusCode(200)
                .body("", equalTo(new InvoiceDTO(project1)));
    }
